...
/**
 * Responsible for creating cover GUI. See also: {@link GT_CoverBehaviorBase#buildUI}
 */
public class CoverUIFactory extends AbstractUIFactory<CoverGuiData> {
     ...
     * {@link GT_CoverBehaviorBase#buildUI}.
     *
     ...
     */
    public static void open(EntityPlayerMP player, int coverID, ICoverable tile, ForgeDirection side,
